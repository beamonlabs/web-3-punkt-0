        ...
        {  
            ...
            <div id="consultant-container">
                ...
                {             
                    ...
                    <!-- Left container -->         
                    <div id="left-consultant-container">
                        <div id="emphasized-circle">
                            ...
                            <div id="emphasized-circle-text">
                                <div id="emphasized-circle-wrap">  
                                    ...
                                    <p id="new-article-title">"<?php echo get_the_title() ?>"</p></br>
                                    <p id="new-article-author"><?php echo get_the_date() ?>, <?php echo $firsttag ?></p>
                ...
                <!-- Right container -->
                <div id="right-consultant-container">
                    <h2 id="consultant-title"><?php echo $instance["title"] ?></h2>
                    <ul>
                        <?php
                        while ( $the_query->have_posts() ) 
                        {
                            ...
                            <li>
                                <a class="consultant-post-title" href="<?php echo get_the_permalink() ?>" rel="bookmark"><?php get_the_title() ?></a>
                                </br></br>
